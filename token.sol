...
contract TARP is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmount = 1e10 * 10**_decimals;
    ...
    string private constant _name = "Totally A Rug Pull";
    string private constant _symbol = "TARP";
